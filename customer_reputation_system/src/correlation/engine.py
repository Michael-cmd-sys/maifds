...
from ..mule_network.models import MuleAccount, NetworkRiskMetrics
...
class CrossEntityCorrelationEngine:
    ...
    def find_agent_merchant_correlations(self, min_correlation_score: float = 0.5) -> List[Dict[str, Any]]:
        ...
        SELECT 
            ...
            m.merchant_id, m.merchant_name, m.reputation_score as merchant_reputation_score,
        ...
        for rel in relationships:
            ...
            if correlation_score >= min_correlation_score:
                correlations.append({
                    ...
                    "merchant_reputation_score": rel["merchant_reputation_score"],
    ...
    def find_high_value_targets(self, min_transaction_amount: float = 10000) -> List[Dict[str, Any]]:
        ...
        # a.risk_score - For some reason this column is failing to show and throwing an error althouh I have verified it exists
        query = """
        SELECT 
            an.agent_id, a.agent_name,
