...
try:
    from .models import AgentRiskProfile, AgentRiskFactors, AgentNetworkMetrics
    ...
    from customer_reputation_system.src.agents.models import AgentRiskProfile, AgentRiskFactors, AgentNetworkMetrics
